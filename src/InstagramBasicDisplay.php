 ...
 * @since     1.0.0
 *
 * @property  InstagramBasicDisplayServiceService $instagramBasicDisplayService
 */
class InstagramBasicDisplay extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'instagram-basic-display/default';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger1'] = 'instagram-basic-display/default/do-something';
            }
        );
